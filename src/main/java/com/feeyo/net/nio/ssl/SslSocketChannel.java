...
public class SslSocketChannel implements WrappedByteChannel, ByteChannel, SslChannel {
  //
  private final Logger LOGGER = LoggerFactory.getLogger(SslSocketChannel.class);
  ...
  public SslSocketChannel(SocketChannel inputSocketChannel, SSLEngine inputEngine,
    ...
    if (doHandshake()) {
      ...
      try {
        ...
        LOGGER.error("Exception during the closing of the channel", e);
      }
    }
  }
  ...
  public synchronized int read(ByteBuffer dst) throws IOException {
    ...
    if (peerAppData.hasRemaining()) {
      peerAppData.flip();
      return BufferUtil.transferByteBuffer(peerAppData, dst);
    }
    peerNetData.compact();
    ...
    if (bytesRead > 0 || peerNetData.hasRemaining()) {
      ...
      while (peerNetData.hasRemaining()) {
        ...
        try {
          ...
          LOGGER.error("SSLException during unwrap", e);
          throw e;
        }
    ...
    BufferUtil.transferByteBuffer(peerAppData, dst);
    return bytesRead;
  }
