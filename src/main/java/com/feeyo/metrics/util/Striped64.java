package com.feeyo.metrics.util;
...
abstract class Striped64 extends Number {
	...
	private static final long serialVersionUID = 2764737297641869521L;
     ...
     * cell数组，长度一样要是2^n，可以类比为jdk1.7的ConcurrentHashMap中的segments
     */
     ...
     * 2、多线程并发初始化table数组时，必须要保证table数组只被初始化一次，
     *   因此只有一个线程能够竞争成功，这种情况下竞争失败的线程会尝试在base上进行一次累积操作
     * 
     */
